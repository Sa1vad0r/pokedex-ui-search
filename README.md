...
- Retrieve live data from the PokeAPI
- Display detailed Pokémon information, including:
  - Name
  - Types
  - Abilities
  - Base stats
- Object-oriented design using `Pokemon` and `Pokedex` classes
- Unit tests for API functions and core classes
